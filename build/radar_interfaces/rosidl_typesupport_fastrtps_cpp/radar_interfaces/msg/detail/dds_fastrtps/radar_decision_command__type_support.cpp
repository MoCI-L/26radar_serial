...
#include "radar_interfaces/msg/detail/radar_decision_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_interfaces::msg::RadarDecisionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_interfaces::msg::RadarDecisionCommand & ros_message)
{
  // Member: sender_id
  cdr >> ros_message.sender_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_radar_interfaces
max_serialized_size_RadarDecisionCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_interfaces::msg::RadarDecisionCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::RadarDecisionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_interfaces::msg::RadarDecisionCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RadarDecisionCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::RadarDecisionCommand *>(
...
static size_t _RadarDecisionCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RadarDecisionCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RadarDecisionCommand__callbacks = {
...
static rosidl_message_type_support_t _RadarDecisionCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RadarDecisionCommand__callbacks,
...
{
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_RadarDecisionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_interfaces, msg, RadarDecisionCommand)() {
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_RadarDecisionCommand__handle;
}
