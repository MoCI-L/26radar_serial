...
#include "radar_interfaces/msg/detail/enemy_ammo__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_interfaces::msg::EnemyAmmo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_interfaces::msg::EnemyAmmo & ros_message)
{
  // Member: hero_ammo
  cdr >> ros_message.hero_ammo;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_interfaces::msg::EnemyAmmo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::EnemyAmmo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_interfaces::msg::EnemyAmmo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnemyAmmo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::EnemyAmmo *>(
...
static size_t _EnemyAmmo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnemyAmmo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnemyAmmo__callbacks = {
...
static rosidl_message_type_support_t _EnemyAmmo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnemyAmmo__callbacks,
...
{
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_EnemyAmmo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_interfaces, msg, EnemyAmmo)() {
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_EnemyAmmo__handle;
}
