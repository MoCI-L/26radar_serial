...
static const _EnemyAmmo_type_support_symbol_names_t _EnemyAmmo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, radar_interfaces, msg, EnemyAmmo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, radar_interfaces, msg, EnemyAmmo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, radar_interfaces, msg, EnemyAmmo)() {
  return &::radar_interfaces::msg::rosidl_typesupport_c::EnemyAmmo_message_type_support_handle;
}
